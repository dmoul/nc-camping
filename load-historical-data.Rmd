...
###### Create feature files, one per year of NC reservations
...
for(i in 2006:2018) { # 2006:2018
  ...
  write_feather(tbl, paste0("./data/processed/nc_by_year_semiprocessed/nc_", i, ".feather"))
}

## The above ran 2021-11-14 with these warnings:
# working on 2010
