...
This complicates matters. Since the difference is at most `r product_id_diff` (`r percent(product_id_diff_pct)`), I generally work with "group_by(facility_id, site_type_simple)" and ignore the differences otherwise. 
...
parks_all_years_overnight_for_plot %>%
  ...
  labs(title = "Number of facilities newly offering \nsite_type_simple with 'Overnight' use_type",
       subtitle = glue("As represented in published recreation.gov data set",
                       ...
                       "\neBy end of {year_lower_bound} it seems most existing sites were reservable"),
