...
3. Some campsites have become reservable during the years covered in this data set. For example, the NPS campgrounds at Cape Hatteras: Oregon Inlet and Frisco started taking reservations in 2015, and Cape Point started in 2016. When looking at mulit-year growth, including these campgrounds unduly inflates the growth rate.
...
Since the data set does not incluce a declared number of sites per facility+site_type that is reliable, I calculate the daily and weekly percent occupancy as the percent of the maximum recorded occupancy for the campground + site type over the years of interest. 
...
Truly there are more people camping more nights at federally-owned facilities in North Carolina. The clearest increase can be seen in [Are there trends by day of the week?] in the plot *NC camping each night of the week (person-nights)*: each year, every day of the week, in the summer and off-season, there were more people camping. Until the pandemic derailed the trend in 2020.
